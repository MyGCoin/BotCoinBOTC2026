...
These are the dependencies currently used by BotCoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/botcoinnl
Keybase  - https://keybase.io/team/botcoin/
