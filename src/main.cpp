...
#if defined(NDEBUG)
# error "BotCoin cannot be compiled without assertions."
#endif
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
    ...
    // BotCoin: in v2 transactions use GetAdjustedTime() as TxTime
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // BotCoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // BotCoin also requires low S in sigs
