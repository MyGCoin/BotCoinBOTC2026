...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s botcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  botcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded botcoin transaction") + "\n" +
              "  botcoin-tx [options] -create [commands]   " + _("Create hex-encoded botcoin transaction") + "\n" +
              "\n";
