...
const char* BIP71_MIMETYPE_PAYMENT = "application/botcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/botcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/botcoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click botcoin: links
...
//
// OSX-specific way of handling botcoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in botcoin: URIs
...
bool PaymentServer::handleURI(const QString &scheme, const QString &s)
{
    ...
    else
    {
        Q_EMIT message(tr("URI handling"), tr("URI cannot be parsed! This can be caused by an invalid "
                                              "BotCoin address or malformed URI parameters."),
            CClientUIInterface::ICON_WARNING);
    }
