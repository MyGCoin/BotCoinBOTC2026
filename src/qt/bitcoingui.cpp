...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BotCoin address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BotCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BotCoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible BotCoin command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("BotCoin"); // default title
