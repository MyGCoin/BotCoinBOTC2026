 ...
 * between botcoind, and botcoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/MyGCoin>";
    const std::string URL_WEBSITE = "<https://botsocial.ai/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The BotCoin Developers", 2026)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find BotCoin useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("BotCoin More version %s\n", FormatFullVersion());
}
