...
unlocked to sign the BotCoin-Qt.app bundle.
...
allowing somebody to distribute a BotCoin-Qt.app or botcoin-qt-setup.exe with a valid
...
that the botcoin-qt.exe file inside the installer had not been tampered with.
