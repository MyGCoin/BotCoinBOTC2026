...
BotCoin is the name of open source software which enables the use of this currency. It takes BotCoin to the next level by building upon
Bitcoin Core 0.13.2 with some patches from newer Bitcoin Core versions to offer performance enhancements, wider compatibility with third party services and a more advanced base.

For more information, as well as an immediately useable, binary version of the BotCoin software, see https://botsocial.ai.

License
-------

BotCoin is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
completely stable. [Tags](https://github.com/MyGCoin/tags) are created
regularly to indicate new official, stable release versions of BotCoin.
...
### 13.2
The release branch for BotCoin 13.2.x. It is intended to contain stable and functional code that has been thoroughly tested and reviewed.

### 25.x
The release branch for BotCoin 25.x. Contains functional but experimental code.

### 26.x
The release branch for BotCoin 26.x. Contains functional but highly experimental code.
